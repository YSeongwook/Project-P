...
public class GoldBuyPopup : MonoBehaviour
{
    ...
    [SerializeField] private RectTransform recTransform; //패키지 아이콘 크기
    ...
    public void SetPackageInfo(GoldPackageData pakagedata)
    {
        ...
        if (pakagedata.PackageID == "G1001") recTransform.sizeDelta = new Vector2(206, 153);
        else if (pakagedata.PackageID == "G1002") recTransform.sizeDelta = new Vector2(217, 155);
        else if(pakagedata.PackageID == "G1003") recTransform.sizeDelta = new Vector2(230, 177);
        else if (pakagedata.PackageID == "G1004") recTransform.sizeDelta = new Vector2(269, 207);
        else if (pakagedata.PackageID == "G1005") recTransform.sizeDelta = new Vector2(340, 270);
